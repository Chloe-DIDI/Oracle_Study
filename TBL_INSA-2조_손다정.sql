...
*/
/*
BIN$8ySBI9IUQIC6i0mZmVRM9g==$0	TABLE	
BIN$FWIe5bG9SDieIlQkcKBk+Q==$0	TABLE	
BONUS	                        TABLE	
DEPT	                        TABLE	
EMP                         	TABLE	
EMP2	                        TABLE	
...
SELECT *
FROM TBL_INSA
WHERE CITY = '서울' AND SUBSTR(SSN,1,2) = 70;
--==>> @ 
/*
...
SELECT *
FROM TBL_INSA
WHERE SUBSTR(SSN, 8, 1) = 1 AND SUBSTR(SSN, 1, 1) = 7 AND CITY='서울';
--==>> @ 남자 판별 70년대는 1 // 70년대는 첫번째자리가 7인거
/*
...
SELECT NAME, SSN, TO_NUMBER(TO_CHAR(SYSDATE,'YYYY'))-TO_NUMBER(TO_CHAR(19||SUBSTR(SSN,1,2)))"나이"
FROM TBL_INSA;
--==>> @
/*
...
SELECT *
FROM TBL_INSA
WHERE TO_CHAR(SUBSTR(SSN,4,1))=05;
--==>> @
/*
1006	이기자	780505-2978541	02/02/11	인천	010-3214-5357	개발부	과장	2265000	150000
1007	장인철	780506-1625148	98/03/16	제주	011-2345-2525	개발부	대리	1250000	150000
...
--26. 서울 사람 중에서 기본급+수당(→급여) 내림차순으로 정렬.
    ( 이름, 출신도, 기본급+수당 );
SELECT NAME"이름", CITY"출신", BASICPAY+SUDANG"급여" 
FROM TBL_INSA
ORDER BY "급여" DESC;
--==>> @
/*
...
SELECT *
FROM TBL_INSA
WHERE SUBSTR(SSN,8,1) IN (1,3)  --> 남자
ORDER BY TO_NUMBER(TO_CHAR(SYSDATE,'YYYY'))-TO_NUMBER(TO_CHAR(19||SUBSTR(SSN,1,2))) ASC;
--==>>@ 
/*
1017	엄용수	820507-1452365	00/08/28	인천	010-3254-2542	개발부	사원	950000	210000
1044	지수환	820305-1475286	04/01/21	서울	011-5555-7548	영업부	사원	1060000	220000
...
--31. 출신도가 서울, 부산, 대구 이면서
    ...
    ( 이름, 출신도, 부서명, 전화번호 );
SELECT NAME, CITY, SUBSTR(BUSEO,1,2), TEL
FROM TBL_INSA
...
SELECT NAME
,      TEL
,      NVL2(TEL,REPLACE(TEL,'-',''),'전화번호없음')
FROM TBL_INSA;

--==>> @
/*
홍길동	011-2356-4528	01123564528
이순신	010-4758-6532	01047586532
이순애	010-4231-1236	01042311236
김정훈	019-5236-4221	01952364221
한석봉	018-5211-3542	01852113542
이기자	010-3214-5357	01032145357
장인철	011-2345-2525	01123452525
김영년	016-2222-4444	01622224444
나윤균	019-1111-2222	01911112222
김종서	011-3214-5555	01132145555
유관순	010-8888-4422	01088884422
정한국	018-2222-4242	01822224242
조미숙	019-6666-4444	01966664444
황진이	010-3214-5467	01032145467
이현숙	016-2548-3365	01625483365
이상헌	010-4526-1234	01045261234
엄용수	010-3254-2542	01032542542
이성길	018-1333-3333	01813333333
박문수	017-4747-4848	01747474848
유영희	011-9595-8585	01195958585
홍길남	011-9999-7575	01199997575
이영숙	017-5214-5282	01752145282
김인수		            전화번호없음
김말자	011-5248-7789	01152487789
우재옥	010-4563-2587	01045632587
김숙남	010-2112-5225	01021125225
김영길	019-8523-1478	01985231478
이남신	016-1818-4848	01618184848
김말숙	016-3535-3636	01635353636
정정해	019-6564-6752	01965646752
지재환	019-5552-7511	01955527511
심심해	016-8888-7474	01688887474
김미나	011-2444-4444	01124444444
이정석	011-3697-7412	01136977412
정영희		            전화번호없음
이재영	011-9999-9999	01199999999
최석규	011-7777-7777	01177777777
손인수	010-6542-7412	01065427412
고순정	010-2587-7895	01025877895
박세열	016-4444-7777	01644447777
문길수	016-4444-5555	01644445555
채정희	011-5125-5511	01151255511
양미옥	016-8548-6547	01685486547
지수환	011-5555-7548	01155557548
홍원신	011-7777-7777	01177777777
허경운	017-3333-3333	01733333333
산마루	018-0505-0505	01805050505
이기상                 전화번호없음
이미성	010-6654-8854	01066548854
이미인	011-8585-5252	01185855252
권영미	011-5555-7548	01155557548
권옥경	010-3644-5577	01036445577
김싱식	011-7585-7474	01175857474
정상호	016-1919-4242	01619194242
정한나	016-2424-4242	01624244242
전용재	010-7549-8654	01075498654
이미경	016-6542-7546	01665427546
김신제	010-2415-5444	01024155444
임수봉	011-4151-4154	01141514154
김신애	011-4151-4444	01141514444
*/
...
SELECT DECODE(D.등급,'1','100만원미만','2','100~200만원','3','200만원이상','없음')"월급등급",COUNT(*)"직원수"
    FROM 
    (
...
SELECT TO_CHAR(SUBSTR(SSN,1,2))"년도", COUNT(*)"직원수"
FROM TBL_INSA
GROUP BY TO_CHAR(SUBSTR(SSN,1,2)) ;  --> 년도
--==>> @
/*
73	1
75	1
...
SELECT *
FROM TBL_INSA
ORDER BY TO_CHAR(SUBSTR(IBSADATE,4,2)) ASC, TO_CHAR(SUBSTR(IBSADATE,1,2)) DESC;
--       TO_CHAR(IBSADATE,'MM') ASC, TO_CHAR(IBSADATE,'YYYY') DESC;  하면 더 간단하네,,,,,다 풀고 알아챔
--==>> @
/*
1044	지수환	820305-1475286	04/01/21	서울	011-5555-7548	영업부	사원	1060000	220000
1031	지재환	771115-1687988	01/01/21	서울	019-5552-7511	기획부	부장	2450000	160000
...
SELECT COUNT(*)"전체인원수"
,      COUNT(DECODE(SUBSTR(SSN, 8, 1), '1', 1))"남자인원수"
,      COUNT(DECODE(SUBSTR(SSN, 8, 1), '2', 1))"여자인원수"
  FROM TBL_INSA;
--==>> @
/*
60	31	29
...
--39. 서울 사람의 남자 인원수 조회.
SELECT COUNT(DECODE(SUBSTR(SSN, 8, 1), '1', 1))"남자인원수"
FROM TBL_INSA
WHERE CITY='서울';
--==>> @
/*
...
SELECT COUNT(DECODE(SUBSTR(SSN, 8, 1), '1', 1))"남자인원수",COUNT(DECODE(SUBSTR(SSN, 8, 1), '2', 1))"여자인원수"
FROM TBL_INSA
WHERE BUSEO = '영업부';
--==>> @
/*
...
SELECT SUM(DECODE(SUBSTR(SSN,8,1),'1',BASICPAY))"남자" 
,      SUM(DECODE(SUBSTR(SSN,8,1),'2',BASICPAY))"여자" 
FROM TBL_INSA
WHERE CITY='서울';
--==>> @
/*
...
SELECT ROUND(AVG(DECODE(SUBSTR(SSN,8,1),'1',BASICPAY)))"남자"
,      ROUND(AVG(DECODE(SUBSTR(SSN,8,1),'2',BASICPAY)))"여자"
FROM TBL_INSA;
--==>> @
/*
1676168	1428634
...
SELECT AVG(DECODE(SUBSTR(SSN,8,1),'1',BASICPAY))"남자"
,      AVG(DECODE(SUBSTR(SSN,8,1),'2',BASICPAY))"여자"
FROM TBL_INSA
WHERE BUSEO = '개발부';
--==>> @
/*
...
SELECT BUSEO, COUNT(DECODE(SUBSTR(SSN,8,1),'1',BUSEO))"남자"
,             COUNT(DECODE(SUBSTR(SSN,8,1),'2',BUSEO))"여자"
FROM TBL_INSA
GROUP BY BUSEO;
--==>> @
/*
...
SELECT CITY, COUNT(DECODE(SUBSTR(SSN,8,1),'1',1))"남자"
...
SELECT BUSEO, COUNT(DECODE(SUBSTR(SSN,8,1),'1',BUSEO))"남자"
,             COUNT(DECODE(SUBSTR(SSN,8,1),'2',BUSEO))"여자"
,             SUM(DECODE(SUBSTR(SSN,8,1),'1',BASICPAY))"남자급여합" 
,             SUM(DECODE(SUBSTR(SSN,8,1),'2',BASICPAY))"여자급여합" 
FROM TBL_INSA
WHERE CITY='서울'
GROUP BY BUSEO;
--==>> @
...
SELECT BUSEO, COUNT(DECODE(SUBSTR(SSN,8,1),'1',1))"남자"
,             COUNT(DECODE(SUBSTR(SSN,8,1),'2',1))"여자"
FROM TBL_INSA
GROUP BY BUSEO
...
,      TO_CHAR(SYSDATE,'YYYY')-TO_CHAR(19||SUBSTR(SSN,1,2))"나이"
FROM TBL_INSA;
--==>> @
/*
홍길동	남자	44
...
SELECT TO_CHAR(EXTRACT(MONTH FROM IBSADATE))||'월', COUNT(*)||'명'
FROM TBL_INSA
...
SELECT NAME
,      TO_CHAR(TO_DATE(19||SUBSTR(SSN,1,6)),'YYYY-MM-DD')"생년월일"
,      TO_CHAR(BASICPAY,'999,999,999')
,      TO_CHAR(SUDANG,'999,999,999')
FROM TBL_INSA;
--==>> @
/*
...
SELECT NAME, SSN, TO_CHAR(IBSADATE,'YYYY-MM-DD')"입사일"
FROM TBL_INSA
...
SELECT BUSEO, JIKWI, COUNT(*)"인원수", SUM(BASICPAY+SUDANG)"급여합", ROUND(AVG(BASICPAY+SUDANG))"급여평균"
FROM TBL_INSA 
GROUP BY BUSEO, JIKWI;
--==>> @
/*
...
FROM TBL_INSA
WHERE SUBSTR(SSN,8,1)=2 AND EXTRACT(YEAR FROM IBSADATE) = 2000;
--==>> @
/*
...
,     COUNT(*)"인원수"
FROM TBL_INSA
GROUP BY CITY, DECODE(SUBSTR(SSN,8,1),'1','남자','2','여자');
--==>> @
/*
전남	여자	2
전남	남자	1
...
SELECT BUSEO, COUNT(DECODE(SUBSTR(SSN,8,1),'1',1))"남자인원수"
FROM TBL_INSA
...
SELECT NAME, BASICPAY
FROM (
        SELECT NAME, BASICPAY, RANK() OVER(ORDER BY BASICPAY DESC)"상위"
        FROM TBL_INSA
     )
WHERE "상위"<= 0.1;
-->> ??????????????????????ㅠㅠ
...
SELECT *
FROM (
        SELECT NAME, BASICPAY, RANK() OVER(ORDER BY BASICPAY DESC)"5 순위"
        FROM TBL_INSA
     )
WHERE "5 순위"<= 5;
--==>> @
...
SELECT NAME, IBSADATE
FROM (
        SELECT NAME, IBSADATE, RANK() OVER(ORDER BY IBSADATE ASC)"5 순위"
        FROM TBL_INSA
     )
WHERE "5 순위"<= 5;
--==>> @
...
--81. 직원 전체 평균 급여보다 많은 급여를 받는 직원의 수 조회. ------->> 77번 이랑 비슷!
...
WHERE BUSEO = (SELECT BUSEO
               FROM TBL_INSA
               WHERE NAME='김신애' AND JIKWI = (SELECT JIKWI
                                                FROM TBL_INSA
                                                WHERE NAME='김신애')
);
--==>> @
...
,      RANK() OVER(PARTITION BY DECODE(SUBSTR(SSN,8,1),'1','남','2','여') ORDER BY BASICPAY DESC) "순위"
,       BASICPAY"기본급"
FROM TBL_INSA;
--==>> @
/*
...
SELECT *
FROM (
        SELECT NAME, CITY, BASICPAY+SUDANG"급여", RANK() OVER(ORDER BY BASICPAY+SUDANG ASC)"1순위"
        FROM TBL_INSA
...
SELECT BUSEO"부서",ROUND(AVG(BASICPAY))"평균급여"
,  (
    CASE WHEN AVG(BASICPAY)>2500000  THEN 'A'
         WHEN AVG(BASICPAY) BETWEEN 1500000 AND 2500000  THEN 'B'
