...
-- ex)
-- COUNTRIES02 / DEPARTMENTS02 / EMPLOYEES02 / JOBS02 / JOB_HISTORY02 / LOCATIONS02 / REGIONS02
-- 와 같이 구성한다.
...
--○ 오탈자 있는지 쉬운 확인방법
--<<        <<여기서부터  >> 여기까지 드래그 해서  
--          https://kr.piliapp.com/text-diff/#diff 여기서 위에 질의결과, 밑에 질의결과1
--          넣어서 비교하면 바로 뭐가 오탈자인지 나옴   
/*
SELECT *
...
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('AD_PRES','President',20080,40000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('AD_VP','Administration Vice President',15000,30000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('AD_ASST','Administration Assistant',3000,6000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('FI_MGR','Finance Manager',8200,16000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('FI_ACCOUNT','Accountant',4200,9000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('AC_MGR','Accounting Manager',8200,16000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('AC_ACCOUNT','Public Accountant',4200,9000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('SA_MAN','Sales Manager',10000,20080);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('SA_REP','Sales Representative',6000,12008);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('PU_MAN','Purchasing Manager',8000,15000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('PU_CLERK','Purchasing Clerk',2500,5500);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('ST_MAN','Stock Manager',5500,8500);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('ST_CLERK','Stock Clerk',2008,5000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('SH_CLERK','Shipping Clerk',2500,5500);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('IT_PROG','Programmer',4000,10000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('MK_MAN','Marketing Manager',9000,15000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('MK_REP','Marketing Representative',4000,9000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('HR_REP','Human Resources Representative',4000,9000);
INSERT INTO JOBS02(JOB_ID, JOB_TITLE, MIN_SALARY, MAX_SALARY) VALUES('PR_REP','Public Relations Representative',4500,10500);

-->> 삽입 완료

--==========================================================================================

-- JOBS_HISTORY02 테이블 생성
CREATE TABLE JOB_HISTORY02
( EMPLOYEE_ID       NUMBER(6)     CONSTRAINT JHIST02_EMPLOYEE_NN  NOT NULL 
, START_DATE        DATE          CONSTRAINT JHIST02_START_DATE_NN  NOT NULL
, END_DATE          DATE          CONSTRAINT JHIST02_END_DATE_NN  NOT NULL 
, JOB_ID            VARCHAR2(10)  CONSTRAINT JHIST02_JOB_NN  NOT NULL
, DEPARTMENT_ID     NUMBER(4)
, CONSTRAINT JHIST02_EMP_ID_ST_DATE_PK PRIMARY KEY(EMPLOYEE_ID, START_DATE) 
, CONSTRAINT JHIST02_JOB_FK FOREIGN KEY(JOB_ID)
                            REFERENCES JOBS02(JOB_ID)
, CONSTRAINT JHIST02_DATE_INTERVAL CHECK (END_DATE > START_DATE)
);

-->> 생성 완료

-- 데이터 입력
INSERT INTO JOB_HISTORY02(EMPLOYEE_ID, START_DATE, END_DATE, JOB_ID, DEPARTMENT_ID) 
...
-- REGIONS02 테이블 생성
CREATE TABLE REGIONS02
(REGION_ID   NUMBER        CONSTRAINT REGION02_ID_NN NOT NULL
,REGION_NAME VARCHAR2(25) 
,CONSTRAINT REG02_ID_PK PRIMARY KEY(REGION_ID) --기본키
);

-->> 생성 완료

-->> 데이터 입력 확인 (순서 잘못 입력해서 롤백 한 번 하고 진행)
SELECT *
FROM REGIONS02;

-- 데이터 입력
INSERT INTO REGIONS02 (REGION_ID,REGION_NAME) VALUES(1,'Europe');
INSERT INTO REGIONS02 (REGION_ID,REGION_NAME) VALUES(2,'Americas');
INSERT INTO REGIONS02 (REGION_ID,REGION_NAME) VALUES(3,'Asia');
INSERT INTO REGIONS02 (REGION_ID,REGION_NAME) VALUES(4,'Middle East and Africa');

--==>> 입력 완료
--==========================================================================================

-- COUNTRIES02 테이블 생성
CREATE TABLE COUNTRIES02  
(COUNTRY_ID    CHAR(2)        CONSTRAINT COUNTRY02_ID_NN NOT NULL                                                                           
,COUNTRY_NAME  VARCHAR2(40)                                                                         
,REGION_ID     NUMBER   
,CONSTRAINT COUNTRY02_C_ID_PK  PRIMARY KEY(COUNTRY_ID) --기본키
,CONSTRAINT COUNTR02_REG_FK  FOREIGN KEY (REGION_ID) REFERENCES REGIONS02(REGION_ID) --외래키
);  
-->> 생성 완료

--데이터 입력
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('AR', 'Argentina', 2);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('AU', 'Australia', 3);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('BE', 'Belgium', 1);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('BR', 'Brazil', 2);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('CA', 'Canada', 2);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('CH', 'Switzerland',1 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('CN', 'China', 3);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('DE', 'Germany',1 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('DK', 'Denmark', 1);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('EG', 'Egypt',4 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('FR', 'France',1 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('IL', 'Israel', 4);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('IN', 'India', 3);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('IT', 'Italy',1 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('JP', 'Japan',3 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('KW', 'Kuwait',4 );
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('ML', 'Malaysia', 3);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('MX', 'Mexico', 2);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('NG', 'Nigeria', 4);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('NL', 'Netherlands', 1);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('SG', 'Singapore', 3);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID)VALUES('UK', 'United Kingdom', 1);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('US', 'United States of America', 2);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('ZM', 'Zambia', 4);
INSERT INTO COUNTRIES02 (COUNTRY_ID,COUNTRY_NAME,REGION_ID) VALUES('ZW', 'Zimbabwe',4 );

-->> 입력 완료
--==========================================================================================

--LOCATIONS02 테이블 생성
CREATE TABLE LOCATIONS02
( LOCATION_ID       NUMBER(4)
, STREET_ADDRESS    VARCHAR2(40)
, POSTAL_CODE       VARCHAR2(12)
, CITY              VARCHAR2(30)   CONSTRAINT LOC02_CITY_NN NOT NULL
, STATE_PROVINCE    VARCHAR2(25)
, COUNTRY_ID        CHAR(2)
, CONSTRAINT LOC02_ID_PK PRIMARY KEY(LOCATION_ID)
, CONSTRAINT LOC02_C_ID_FK FOREIGN KEY(COUNTRY_ID)
             REFERENCES COUNTRIES02(COUNTRY_ID)
);

--> 생성 완료

-- 데이터 입력
INSERT INTO LOCATIONS02(LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) 
...
--○ 오탈자 수정
UPDATE LOCATIONS02
SET STATE_PROVINCE = 'Tokyo Prefecture'
...
--DEPARTMENTS02 테이블 생성
CREATE TABLE DEPARTMENTS02
( DEPARTMENT_ID         NUMBER(4)         
, DEPARTMENT_NAME       VARCHAR2(30)    CONSTRAINT DEPT02_NAME_NN NOT NULL
, MANAGER_ID            NUMBER(6)           
, LOCATION_ID           NUMBER(4)       
, CONSTRAINT DEPT02_ID_PK PRIMARY KEY(DEPARTMENT_ID)                                     
, CONSTRAINT DEPT02_LOC_FK FOREIGN KEY(LOCATION_ID) REFERENCES LOCATIONS02(LOCATION_ID)   
);       
--> 생성 완료

INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (10, 'Administration', 200, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (20, 'Marketing', 201, 1800);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (30, 'Purchasing', 114, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (40, 'Human Resources', 203, 2400);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (50, 'Shipping', 121, 1500);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (60, 'IT', 103, 1400);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (70, 'Public Relations', 204, 2700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (80, 'Sales', 145, 2500);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (90, 'Executive', 100, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (100, 'Finance', 108, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (110, 'Accounting', 205, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (120, 'Treasury', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (130, 'Corporate Tax', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (140,	'Control And Credit', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (150,	'Shareholder Services', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (160,	'Benefits', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (170,	'Manufacturing', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (180,	'Construction', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (190,	'Contracting', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (200,	'Operations', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (210,	'IT Support', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (220,	'NOC', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (230,	'IT Helpdesk', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (240,	'Government Sales', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (250,	'Retail Sales', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (260,	'Recruiting', NULL, 1700);
INSERT INTO DEPARTMENTS02(DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID) VALUES (270,	'Payroll', NULL, 1700);
--> 삽입 완료
...
, LAST_NAME      VARCHAR2(25)    CONSTRAINT EMP02_LAST_NAME_NN NOT NULL
, EMAIL          VARCHAR2(25)    CONSTRAINT EMP02_EMAIL_NN NOT NULL
, PHONE_NUMBER   VARCHAR2(20)
, HIRE_DATE      DATE            CONSTRAINT EMP02_HIRE_DATE_NN NOT NULL
, JOB_ID         VARCHAR2(10)    CONSTRAINT EMP02_JOB_NN NOT NULL
, SALARY         NUMBER(8,2)
, COMMISSION_PCT NUMBER(2,2)
, MANAGER_ID     NUMBER(6)
, DEPARTMENT_ID  NUMBER(4)   
, CONSTRAINT EMP02_EMP_ID_PK PRIMARY KEY (EMPLOYEE_ID)  --기본키
, CONSTRAINT EMP02_DEPT_FK FOREIGN KEY (DEPARTMENT_ID)  --외래키 
             REFERENCES DEPARTMENTS02 (DEPARTMENT_ID)        
, CONSTRAINT EMP02_JOB_FK FOREIGN KEY (JOB_ID)          --외래키
             REFERENCES JOBS02(JOB_ID)         
, CONSTRAINT EMP02_MANAGER_FK FOREIGN KEY (MANAGER_ID)   --외래키
             REFERENCES EMPLOYEES02 (EMPLOYEE_ID)   
, CONSTRAINT EMP02_SALARY_MIN CHECK (salary > 0)       --CHECK
, CONSTRAINT EMP02_EMAIL_UK UNIQUE (EMAIL)             --UNIQUE
);

--> 생성 완료

INSERT INTO EMPLOYEES02(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
...
INSERT INTO EMPLOYEES02(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
VALUES(124,'Kevin','Mourgos','KMOURGOS','650.123.5234','2007-11-16', 'ST_MAN', 5800, NULL, 100, 50);
INSERT INTO EMPLOYEES02(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID)
...
--=====================================위에 데이터 값까지 수정 완료
/*데이터 위에 잘 못 입력 한 거 수정*/

--○ 데이터 오탈자 찾아서 수정

UPDATE EMPLOYEES02
SET PHONE_NUMBER = '650.123.2234'
WHERE EMPLOYEE_ID = 121;
--> 업데이트 완료

UPDATE EMPLOYEES02
SET LAST_NAME = 'Landry'
WHERE EMPLOYEE_ID = 127;
--> 업데이트 완료

--● 제대로 수정 되었는지 확인 --> PHONE_NUMBER  121번
                               --> LAST_NAME     Landry
SELECT *
FROM EMPLOYEES;
...
--테이블 사이에  연결하는 것 ~!!!!!!!!!!!! 해야됨 이것두



ALTER TABLE DEPARTMENTS02
ADD CONSTRAINT DEPT02_MGR_FK FOREIGN KEY(MANAGER_ID)
               REFERENCES EMPLOYEES02(EMPLOYEE_ID);
               
               
ALTER TABLE JOB_HISTORY02
ADD CONSTRAINT JHIST02_DEPT_FK FOREIGN KEY(DEPARTMENT_ID)
               REFERENCES DEPARTMENTS02(DEPARTMENT_ID);

ALTER TABLE JOB_HISTORY02
ADD CONSTRAINT JHIST02_EMP_FK FOREIGN KEY(EMPLOYEE_ID)
               REFERENCES EMPLOYEES02(EMPLOYEE_ID);               
...
오라클 시작하고 새로운 조를 만났는데 다들 친절하시고 착하셔서 잘 어울릴 수 있었다.
모를 때 물어보면 다 같이 머리를 써서 문제를 해결 하려고 하고 해결방법을 먼저
찾은 사람은 바로 바로 말을 해주어 의사소통이 최고로 잘 되었던 것 같다.
팀장은 팀원별 분배와 방향성을 잘 해서 팀원들을 이끌어 나갔고 
팀원들도 너무 좋고 또 다들 열심히 하려는 의지가 있어서 잘 이번 실습 과제를 
끝낼 수 있었던 것 같다.
...
WHERE TABLE_NAME IN ('JOBS02', 'JOB_HISTORY02', 'REGIONS02', 'COUNTRIES02','LOCATIONS02','DEPARTMENTS02', 'EMPLOYEES02');
